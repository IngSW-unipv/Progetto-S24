...
public class MechanicView extends AbsView {
 ...
 // Getter e setter per i bottoni
    ...
    /**
     * Restituisce il bottone per aggiungere un componente.
     * @return Il bottone per aggiungere un componente.
     */
    ...
    /**
     * Restituisce il bottone per aggiungere un pilota.
     * @return Il bottone per aggiungere un pilota.
     */
    ...
    /**
     * Restituisce il bottone per rimuovere un componente.
     * @return Il bottone per rimuovere un componente.
     */
    ...
    /**
     * Restituisce il bottone per rimuovere un pilota.
     * @return Il bottone per rimuovere un pilota.
     */
    ...
    /**
     * Restituisce il bottone per visualizzare i tempi di pit stop.
     * @return Il bottone per visualizzare i tempi di pit stop.
     */
    ...
    /**
     * Restituisce il bottone per visualizzare lo stato dei componenti.
     * @return Il bottone per visualizzare lo stato dei componenti.
     */
    ...
    /**
     * Restituisce il bottone per inserire una richiesta.
     * @return Il bottone per inserire una richiesta.
     */
    ...
    /**
     * Restituisce il bottone per inserire un veicolo.
     * @return Il bottone per inserire un veicolo.
     */
    ...
    /**
     * Restituisce il label ID pilota.
     * @return Il label ID pilota.
     */
    ...
    /**
     * Imposta il label ID pilota con l'ID del pilota della sessione corrente.
     */
    public void setId_p() {
